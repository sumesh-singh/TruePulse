...
const AnalyticsResultsPanel: React.FC<AnalyticsResultsPanelProps> = ({
  ...
  return (
    <Card className="shadow-xl border-0 bg-card/90 backdrop-blur-lg transition-colors">
      <CardHeader className="pb-2 pt-6 border-b border-muted/50 bg-card/80 rounded-t-lg sticky top-0 z-10">
      ...
      <ScrollArea className="w-full max-h-[68vh] px-2">
        <CardContent className="p-4 md:p-6 lg:p-8 animate-in fade-in duration-700 space-y-7">
          {parseWarning && (
            <div className="mb-4 p-4 bg-yellow-50 border-l-4 border-yellow-500 text-yellow-900 rounded-lg shadow-sm text-sm">
              <div className="font-bold mb-1">⚠️ Article Extraction Warning</div>
              <div className="opacity-90">{parseWarning}</div>
            </div>
          )}

          {analyzedText && (
            <div className="p-4 rounded-lg bg-muted border border-muted shadow-inner mb-2">
          ...
          {error && (
            <div className="text-center py-8">
              <AlertCircle className="h-16 w-16 mx-auto mb-4 text-red-500 drop-shadow" />
          ...
          {!analysisResult && !isAnalyzing && !error && (
            <div className="text-center py-12 text-muted-foreground opacity-80">
          ...
          {analysisResult && !error && (
            <div className="space-y-6 font-medium text-base">
              ...
              <div className="p-5 rounded-xl bg-accent/75 border border-accent shadow transition-colors">
                <h3 className="font-semibold text-foreground mb-2 text-lg pb-1 border-b border-muted/70">Authenticity Assessment</h3>
              ...
              {/* Sentiment Analysis */}
              <div className="p-5 rounded-xl bg-accent border border-accent shadow transition-colors">
                <h3 className="font-semibold text-foreground mb-2 text-lg pb-1 border-b border-muted/60">Sentiment Analysis</h3>
                <div className="flex items-center justify-between">
              ...
              {/* Key Topics */}
              <div className="p-5 rounded-xl bg-muted/80 border border-muted/70 shadow transition-colors">
                <h3 className="font-semibold text-foreground mb-2 text-lg pb-1 border-b border-muted/80">Key Topics</h3>
              ...
              {/* AI Reasoning */}
              {hasValidReasoning && (
                <div className="p-5 rounded-xl bg-gradient-to-r from-purple-50 to-indigo-50 dark:from-purple-950 dark:to-indigo-950 border border-purple-200 dark:border-purple-800 transition-colors shadow">
                  <h3 className="font-semibold text-foreground mb-2 text-lg flex items-center gap-2 pb-1 border-b border-purple-100 dark:border-purple-900">
                    <Brain className="h-5 w-5 text-purple-600" />
                    AI Reasoning Report
                  </h3>
                  <div className="text-sm text-muted-foreground bg-background/60 dark:bg-background/30 p-3 rounded border">
              ...
              {similarArticles.length > 0 && (
                <div className="p-5 rounded-xl bg-accent border border-accent shadow transition-colors">
                  <h3 className="font-semibold text-foreground mb-3 text-lg pb-1 border-b border-muted/60">Related Articles</h3>
                  <div className="space-y-3">
                    {similarArticles.map((article, index) => (
                      <div key={index} className="flex items-start space-x-3 p-3 bg-card rounded-lg border border-border hover:border-blue-300 shadow-sm transition-colors">
              ...
              {/* Summary Stats */}
              <div className="grid grid-cols-2 gap-4">
                <div className="p-4 rounded-lg bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950 dark:to-indigo-900 border border-blue-100 dark:border-blue-900 text-center shadow">
                ...
                <div className="p-4 rounded-lg bg-gradient-to-r from-emerald-50 to-green-50 dark:from-emerald-900 dark:to-green-900 border border-emerald-100 dark:border-emerald-900 text-center shadow">
